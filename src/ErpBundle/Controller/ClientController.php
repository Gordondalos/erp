...
class ClientController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ErpBundle:Client')->findAll();

        return $this->render('ErpBundle:Client:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('ErpBundle:Client:new.html.twig', array(
            'entity' => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('ErpBundle:Client:edit.html.twig', array(
            'entity'      => $entity,
