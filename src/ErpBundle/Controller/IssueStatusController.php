...
use ErpBundle\Entity\IssueStatus;
use ErpBundle\Form\IssueStatusType;
...
class IssueStatusController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('ErpBundle:IssueStatus:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('ErpBundle:IssueStatus:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ErpBundle:IssueStatus')->find($id);
        ...
        return $this->render('ErpBundle:IssueStatus:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('ErpBundle:IssueStatus:edit.html.twig', array(
            'entity'      => $entity,
