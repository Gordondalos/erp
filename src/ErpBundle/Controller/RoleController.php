...
use ErpBundle\Entity\Role;
use ErpBundle\Form\RoleType;
...
// возвращает все роли доступные в проекте
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ErpBundle:Role')->findAll();

        return $this->render('ErpBundle:Role:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('ErpBundle:Role:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ErpBundle:Role')->find($id);
        ...
        return $this->render('ErpBundle:Role:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('ErpBundle:Role:edit.html.twig', array(
            'entity'      => $entity,
