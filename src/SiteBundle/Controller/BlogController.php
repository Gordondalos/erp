...
use SiteBundle\Entity\Blog;
use SiteBundle\Form\BlogType;
...
class BlogController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SiteBundle:Blog')->findAll();

        return $this->render('SiteBundle:Blog:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('SiteBundle:Blog:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SiteBundle:Blog')->find($id);
        ...
        return $this->render('SiteBundle:Blog:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('SiteBundle:Blog:edit.html.twig', array(
            'entity'      => $entity,
