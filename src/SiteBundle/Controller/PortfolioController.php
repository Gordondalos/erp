...
use SiteBundle\Form\PortfolioType;
...
class PortfolioController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('SiteBundle:Portfolio:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('SiteBundle:Portfolio:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        return $this->render('SiteBundle:Portfolio:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('SiteBundle:Portfolio:edit.html.twig', array(
            'entity'      => $entity,
